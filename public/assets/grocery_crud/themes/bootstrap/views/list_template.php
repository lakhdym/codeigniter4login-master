<?php
    ...
    $search_column_string =
        preg_match('/1\.(5\.[6-9]|[6-9]\.[0-9])/', \App\Libraries\GroceryCrud::VERSION)
            ? $this->l('list_search_column') : 'Search {column_name}';

    $hasAlerti18n = preg_match('/1\.(5\.[8-9]|[6-9]\.[0-9])/', \App\Libraries\GroceryCrud::VERSION);
                ...
                <div class=" table-responsive">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    ...
                                    <a href="<?php echo $add_url?>" class="btn btn-primary btn-icon-split">
                                    <span class="icon text-white-50">
                                      <i class="fas fa-plus"></i>
                                    </span>
                                    <span class="text"><?php echo $this->l('list_add'); ?> <?php echo $subject?></span>
                                  </a>
                            ...
                            <div class="floatR">
                                ...
                                <a class="btn btn-primary search-button t5 btn-sm">
                        ...
                        <div class="scroll-if-required">
        			        <table class="dataTable table table-bordered grocery-crud-table table-hover">
        					<thead>
        						<tr>
