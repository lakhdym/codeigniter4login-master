    ...
    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 mt-5 pt-3 pb-3 bg-white from-wrapper">
      <div class="container">
        ...
        <form class="" action="/Backoffice" method="post">
          ...
          <div class="form-group">
           <label for="password"><?= lang('PageLogin.Password'); ?></label>
          ...
          <div class="row">
            <div class="col-12 col-sm-4 offset-md-4">
              <button type="submit" class="btn btn-primary  btn-block waves-effect waves-light"><?= lang('PageLogin.login'); ?></button>
            </div>
